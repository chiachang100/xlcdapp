...
class XlcdVideos extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return XlcdVideosState();
  }
}

enum AppBarBehavior { normal, pinned, floating, snapping }

class XlcdVideosState extends State<XlcdVideos> {
  ...
  Widget _buildBody(BuildContext context) {
    ...
    switch (type) {
      case JoymmType.dev:
        {
          return _buildListFromCache(context, dummyXlcdVideosSnapshot);
        }
        break;
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            GestureDetector(
              ...
              child: Image.asset(
                'assets/images/Xlcd/' + record.icon,
                fit: BoxFit.cover,
              ),
            ),
          ],
